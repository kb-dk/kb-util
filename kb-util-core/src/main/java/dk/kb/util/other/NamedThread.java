...
public class NamedThread implements AutoCloseable {
     ...
     * @return a NamedThread
     */
    public static NamedThread bothfix(String prefix, String postfix) {
        String parentName = Thread.currentThread().getName();
        String threadName = String.join("->", prefix, parentName, postfix);
     ...
     * @return a NamedThread
     */
    public static NamedThread prefix(String name) {
        String parentName = Thread.currentThread().getName();
        String threadName = name + "->" + parentName;
        return new NamedThread(threadName);
    }
